        ...
        @forelse ($coffees as $coffee)
            <div onclick="window.location.assign(`{{ route('coffee', ['id' => $coffee->id]) }}`)"
                ...
                <img class="object-cover w-full h-56 lg:w-64"
                     src="https://images.unsplash.com/photo-1584736286279-5d85d32ba79d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=500&q=80"
                     alt="">
